      ...
      <div className="text">
        ...
        <p>
          ...
          <ul style={{ listStyle: "-moz-initial inside" }}>
            ...
            <li>Первым заданием было реализовать фиксацию входа на windows сервер. Для решения был разработан модуль log.module.ts, где были все необходимые роуты. Модуль включает в себя разработка контроллера, dto, mapper, persistence-service, service и бизнес логики: entity, service, command, query, port.</li>
